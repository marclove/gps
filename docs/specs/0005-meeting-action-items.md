...
- The sidebar is 288 pixels wide when the window is at most about 1000 pixels wide. In a wider window it is wider, by about 6 pixels for each 100 pixels of window width, up to 336 pixels.
